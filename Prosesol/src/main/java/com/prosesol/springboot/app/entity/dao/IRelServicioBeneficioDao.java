...
public interface IRelServicioBeneficioDao extends CrudRepository<RelServicioBeneficio, Long>{
	...
	@Query(value = "select r.id_servicio, r.id_beneficio, r.descripcion, r.titual, r.beneficiario from rel_servicios_beneficios r where r.id_servicio = ?1", nativeQuery = true)
