...
public class AsyncCargaMasiva {
    ...
    public void procesaArchivoAsync(String nombre, byte[] bs) throws InterruptedException, IOException, CustomUserException {
        ...
        try{
            ...
            generarArchivoLog(nombre, numeroRegistros, log);
    ...
    public void generarArchivoLog(String nombre, Integer numeroRegistros, List<String> log){
        ...
        try {
            ...
            logCM = new LogCM(nombre + "_" + dateFormat + ".txt", fechaCreacion, numeroRegistros, data);
